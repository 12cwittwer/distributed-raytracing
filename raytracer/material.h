...
struct material {
    ...
    union {
        ...
        material_diffuse_light* diffuse_light;
    ...
    bool scatter(const ray& r_in, const hit_record& rec, color& attenuation, ray& scattered) const {
        switch (type) {
            ...
            case MATERIAL_METAL:          return metal->scatter(r_in, rec, attenuation, scattered);
            case MATERIAL_DIELECTRIC:     return dielectric->scatter(r_in, rec, attenuation, scattered);
            case MATERIAL_ISOTROPIC:      return isotropic->scatter(r_in, rec, attenuation, scattered);
        }
        return false;
    }
